...
diplomacy = {
	...
	RANK_1_TENSION_DECAY = -0.15, -- extra flashpoint tension decay for GPs
	RANK_2_TENSION_DECAY = -0.15,
	RANK_3_TENSION_DECAY = -0.15,
	RANK_4_TENSION_DECAY = -0.15,
	RANK_5_TENSION_DECAY = -0.15,
	RANK_6_TENSION_DECAY = -0.15,
	RANK_7_TENSION_DECAY = -0.15,
	RANK_8_TENSION_DECAY = -0.15,
...
ai =
{
	...
	MAX_FLEETS = 100, -- Maximal amount of main fleets the AI will divide its navy into (does not include specialized fleets such as blockades and naval invasions)
