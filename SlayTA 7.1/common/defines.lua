...
country = {
	...
	INVESTMENT_SCORE_FACTOR = 0.00, -- how much foreign investment money counts towards your industry score
...
economy = {
	...
	GOODS_FOCUS_SWAP_CHANCE = 0.0001, -- Percent increased chance that artisan wants to change goods independantly of how well he is doing presently
	...
	TRADE_CAP_LOW_LIMIT_CONSTRUCTIONS = 0.01, 		-- the lowest % the slider can go for constructions
	FACTORY_PURCHASE_MIN_FACTOR = 0.95,			-- the lowest % of its daily needs a factory will purchase
...
military = {
	...
	NAVAL_COMBAT_RETREAT_SPEED_MOD = 0.6, -- slow down when retreating so there is a chance to hit the runner
	...
	NAVAL_COMBAT_MAX_TARGETS = 3, -- max number of ships that may target the same enemy ship
	...
	AI_SUPPORT_PROPORTION = 0.8, -- fraction of brigades that should be artillery and other support units
	...
	AI_ARMY_TAXBASE_FRACTION = 1.7, -- max of tax base that AI will spend on army supply costs (based on peacetime costs)
	AI_NAVY_TAXBASE_FRACTION = 1.0, -- max of tax base that AI will spend on navy supply costs (based on peacetime costs)
...
diplomacy = {
	...
	BASE_TRUCE_MONTHS = 0,
	MAX_INFLUENCE = 100,
	WARSUBSIDIES_PERCENT = 0.75, -- How many percent of imports you are going to pay each day(mil. constructions and mil. maintainence)
	...
	RANK_1_TENSION_DECAY = -10.8, -- extra flashpoint tension decay for GPs
	RANK_2_TENSION_DECAY = -10.7,
	RANK_3_TENSION_DECAY = -10.6,
	RANK_4_TENSION_DECAY = -10.5,
	RANK_5_TENSION_DECAY = -10.4,
	RANK_6_TENSION_DECAY = -10.3,
	RANK_7_TENSION_DECAY = -10.3,
	RANK_8_TENSION_DECAY = -10.3,

	TWS_FULFILLED_SPEED = 0.15, -- Ticking War Score grows up with this speed daily once CB is fulfilled
	TWS_NOT_FULFILLED_SPEED = 0.15, -- Ticking War Score falls down when CB is not fulfilled (or after grace period)
...
ai =
{
	COLONY_WEIGHT = 50.0, -- ai weight for colonising
	ADMINISTRATOR_WEIGHT = 10.0, -- ai weight for new bureaucrat
	INDUSTRYWORKER_WEIGHT = 25.0, -- ai weight for new industry workers
	EDUCATOR_WEIGHT = 100.0, -- ai weigth for new clergy
	SOLDIER_WEIGHT = 75.0, -- ai weight for soldiers
	...
	AGGRESSION_UNCIV_BONUS = 180, -- additional AI civ aggression against uncivs
